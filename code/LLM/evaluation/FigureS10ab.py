...
file_path = "../../../data/freezing_rain_random_sample_500.xlsx"
...
plt.tight_layout()
plt.savefig('./Ice_thickness_comparison_raindom.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('./Damage_severity_confusion_matrix_random.png', dpi=300, bbox_inches='tight')
