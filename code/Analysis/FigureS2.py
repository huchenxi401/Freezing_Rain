...
def field_significance_test(yearly_data_dict, ttest_results, n_permutations=10000, alpha=0.05, title_suffix=""):
    print("\n" + "="*70)
    print(f"Field Significance Test (Permutation){title_suffix}")
...
def main():
    try:
        ...
        output_v4 = Path(output_dir) / 'figureS2d.png'
